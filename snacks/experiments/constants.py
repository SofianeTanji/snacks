...
BEST_VALUES["a9a"] = [550, 0.01, 1e-5, int(5e6)]
N_SAMPLES["a9a"] = 32561

BEST_VALUES["ijcnn1"] = [500, 2., 1e-8, int(6e5)]
N_SAMPLES["ijcnn1"] = 49990

BEST_VALUES["SUSY"] = [330, 1e-2, 1e-7, int(5e6)]
N_SAMPLES["SUSY"] = 5e6

BEST_VALUES["HIGGS"] = [3000, 0.0034,  1e-8, 1050000]
N_SAMPLES["HIGGS"] = 11e6

BEST_VALUES["mnist"] = [20000, 0.005, 1e-8, int(2e6)]
N_SAMPLES["mnist"] = 60000

BEST_VALUES["SVHN"] = [2000, 5.45, 1e-8, int(5e6)]
...
BEST_VALUES["covtype.binary"] = [3000, 7e-6,  1e-8, 1050000]
